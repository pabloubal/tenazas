...
func (m *mockEngineForCallback) ExecutePrompt(sess *models.Session, prompt string) {}
func (m *mockEngineForCallback) ExecuteCommand(sess *models.Session, cmd string)   {}
func (m *mockEngineForCallback) Run(skill *models.SkillGraph, sess *models.Session) {
	if skill != nil {
