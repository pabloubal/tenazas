...
func TestAuditLLMThoughtConstant(t *testing.T) {
	...
	if events.AuditLLMThought != "llm_thought" {
		t.Errorf("expected AuditLLMThought to be 'llm_thought', got %s", events.AuditLLMThought)
	}
}
